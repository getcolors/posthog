...
# digitalocean_ssh_key resource and reference it by attribute. `optout.yml`
# supplies an explicit key id and must render the historical shape, byte for
# byte, creating nothing.
#
